...
namespace Projet_TransConnect_TANG
{
    ...
    public class Commande
    {
        ...
        {
            return "Numero Commande : " + numerocommande + ", Client : " + client.ToString() + ", prix : " + prix.ToString() + " € " + "\r\nChauffeur : [ " + chauffeur.ToString() + " ]" + "\r\n" + "Create date : " + createdate.ToString() + ", véhicule : " + vehicule + ", trajet : " + start + " to " + end + "Temps total utilisé: " + Dij.TimeTaken + "\r\n" + "Chemin : " + AfficherCheminParcouru();
        }
        /// <summary>
